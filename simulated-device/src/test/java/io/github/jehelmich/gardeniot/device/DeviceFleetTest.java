...
class DeviceFleetTest {
    ...
    void addsAndRemovesPlantsOnCommand() {
        ...
        assertThat(fleet.handle("addPlant", "{\"deviceId\": \"basil\"}").status()).isEqualTo(409);
        assertThat(fleet.handle("removePlant", "{\"deviceId\": \"basil\"}").status()).isEqualTo(200);
        assertThat(fleet.handle("removePlant", "{\"deviceId\": \"basil\"}").status()).isEqualTo(404);
    ...
    void validatesDeviceIds() {
        assertThat(fleet.handle("addPlant", "{\"deviceId\": \"no spaces\"}").status()).isEqualTo(400);
